...
public class MailSender {
	...
	private static String e_mail = "ebilimkg@yandex.ru";
	private static String name = "e-Bilim";
	private static String password = "ebilim18091993";
	...
	public boolean send(org.ebilim.beans.Message m) {
		...
		try {
			...
			message.setSender(new InternetAddress("ebilimkg@yandex.ru"));
	...
	public void asyncSend(final org.ebilim.beans.Message m) {
